...
#ifndef EVOLVE_LOG_EXPORT_H
#define EVOLVE_LOG_EXPORT_H
...
#ifdef WIN32
#	ifdef EVOLVE_LOG_BUILD_SHARED_LIBRARY
#  		define EVOLVE_LOG_EXPORT __declspec(dllexport)
#	else
#		define EVOLVE_LOG_EXPORT __declspec(dllimport)
#	endif
#else
#	define EVOLVE_LOG_EXPORT
#endif
